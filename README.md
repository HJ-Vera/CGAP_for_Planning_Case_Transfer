...
> “语言的边界就是世界的边界” （Wittgenstein, L.）。本质上，人们对世界的想象会被自己的经历和认知所限制。

大多数人对 LLM 的印象仍停留在“聊天机器人”“问答助手”或“搜索增强”。

但在复杂专业场景中，真正困难的问题往往不是“模型的逻辑推理能力”，而是：
...
本项目尝试探索另一种方向：不是单纯依赖更大的模型，而是通过结构化 Workflow与多阶段推理架构，让现有 LLM 在复杂专业任务中具备更稳定的信息整合与分析能力。

我们希望证明：在合理的系统设计下，LLM 不仅可以“回答问题”，也能够参与复杂决策支持与专业分析流程。
...
**主要功能**：
- Context Modeling ： 加载本地数据，模糊匹配查询区域，执行统计分析与可视化，搜索公众意见，提取核心规划问题并改写为案例检索词。
...
<div align="center">
  <img src="images/Aggregate Agreement between LLM and Human Evaluation.jpg" alt="CGAP 工作流程图" width="600">
</div>  

---

> 💡
> LLM 与人工评分的 Spearman ρ=0.424（p<0.001），方向一致率 74.4%，表明 LLM 能较稳定识别优劣，但在主观维度上的差异幅度校准仍有限；结果支持在复杂任务中优先采用配对比较而非绝对评分
