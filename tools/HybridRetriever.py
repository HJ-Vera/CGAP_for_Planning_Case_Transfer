...
from config import BM25_CANDIDATE_K, HYBRID_ALPHA, SBERT_MODEL_NAME
...
class HybridRetriever:
    ...
    def __init__(self, alpha: float = HYBRID_ALPHA, sbert_model_name: str = SBERT_MODEL_NAME):
        self.alpha = alpha
    ...
    def retrieve(
        ...
        """
        混合检索，返回: [(doc_index, hybrid_score, bm25_norm, sbert_sim), ...]
        """
        ...
        # 混合
        hybrid_scores = self.alpha * bm25_norm + (1 - self.alpha) * sbert_sims
